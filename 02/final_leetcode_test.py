#!/usr/bin/env python3
"""
Final verification that mimics LeetCode's exact environment
This simulates how LeetCode runs your code
"""

# This simulates LeetCode's environment where ListNode is already defined
class ListNode:
    def __init__(self, val=0, next=None):
        self.val = val
        self.next = next

# Your solution (this is what you paste into LeetCode)
class Solution:
...
# Test exactly like LeetCode does
def test_leetcode_environment():
    print("🧪 Testing in LeetCode-like environment...")
    
    # Create test case: [2,4,3] + [5,6,4] = [7,0,8]
    l1 = ListNode(2)
    l1.next = ListNode(4)
